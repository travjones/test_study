...
/***/ function(module, exports, __webpack_require__) {
	...
	function start() {
	  ...
	  var startHTML = "\n    <div class=\"start-container u-full-width\">\n      <h1>Instructions -- Read before you hit Start.</h1>\n      <p>This project involves two sections. In the first section you will be presented with a series of example websites, one at a time. Each website will be presented on the screen for a fixed duration of 30 seconds. The purpose of this section is to familiarize each participant to the different websites we are interested in getting your feedback on. Following this first section, the second section will then present two websites at a time and, after a short period of time, ask you to choose which of the two websites you prefer. During both sections of the study, the websites will automatically scroll for you--we ask that you attend to your computer screen. Please note that you can quit the research project at any time and can contact the Primary Investigator (david.j.cox@ufl.edu) or the Research Supervisor (dallery@ufl.edu) with any questions you may have. Click the button below to begin the study. </p>\n      <div class=\"start-btn\" id=\"start-btn\"><span>Start<span></div>\n    </div>\n  ";
